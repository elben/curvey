...
class TestBSpline(unittest.TestCase):
    ...
    def test_insert_knot(self):
        ...
        self.assertEqual(self.bs1.internal_points[2].polar(), KnotVector([0,1,2]))
        self.assertEqual(self.bs1.internal_points[3].polar(), KnotVector([1,2,3]))
        self.assertEqual(self.bs1.internal_points[4].polar(), KnotVector([2,3,4]))
        self.assertEqual(self.bs1.internal_points[5].polar(), KnotVector([3,4,4]))
        # assert new points have the right x, y.
        self.assertEqual(self.bs1.internal_points[2].x(), 14.0/3)
        self.assertEqual(self.bs1.internal_points[2].y(), 14.0/3)
        self.assertEqual(self.bs1.internal_points[3].x(), 11.0/2)
        self.assertEqual(self.bs1.internal_points[3].y(), 3)
        self.assertEqual(self.bs1.internal_points[4].x(), 4)
        self.assertEqual(self.bs1.internal_points[4].y(), 1)
        ...
        # assert new points added to right place and old points removed
        self.assertEqual(self.bs1.internal_points[2].polar(), KnotVector([0,1,2]))
        self.assertEqual(self.bs1.internal_points[3].polar(), KnotVector([1,2,2]))
        self.assertEqual(self.bs1.internal_points[4].polar(), KnotVector([2,2,2]))
        self.assertEqual(self.bs1.internal_points[5].polar(), KnotVector([2,2,3]))
        self.assertEqual(self.bs1.internal_points[6].polar(), KnotVector([2,3,4]))
        # assert new points have the right x, y.
        self.assertTrue(float_equals(self.bs1.internal_points[3].x(), 47.0/9))
        self.assertTrue(float_equals(self.bs1.internal_points[3].y(), 32.0/9))
        self.assertTrue(float_equals(self.bs1.internal_points[4].x(), 46.0/9))
        self.assertTrue(float_equals(self.bs1.internal_points[4].y(), 53.0/18))
        self.assertTrue(float_equals(self.bs1.internal_points[5].x(), 5))
        self.assertTrue(float_equals(self.bs1.internal_points[5].y(), 7.0/3))
        self.assertTrue(float_equals(self.bs1.internal_points[6].x(), 4))
        self.assertTrue(float_equals(self.bs1.internal_points[6].y(), 1))
